    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 rounded-[1.75rem] border border-orange-500/20 bg-[#141414] p-8 shadow-xl">
        <label className="block text-sm text-gray-300">
          Current Password
          <input type="password" name="current" value={form.current} onChange={handleChange} className="input-field mt-2 bg-[#0b0b0b]" required />
        </label>
        <label className="block text-sm text-gray-300">
          New Password
          <input type="password" name="password" value={form.password} onChange={handleChange} className="input-field mt-2 bg-[#0b0b0b]" required />
        </label>
        <label className="block text-sm text-gray-300">
          Confirm Password
          <input type="password" name="confirm" value={form.confirm} onChange={handleChange} className="input-field mt-2 bg-[#0b0b0b]" required />
        </label>
